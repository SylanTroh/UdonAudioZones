...
namespace AudioZones
{
    ...
    public class EarmuffZone : UdonSharpBehaviour
    {
        ...
        {
            SetPlayerVoice(player, defaultVoiceGain, defaultVoiceRangeFar, defaultVoiceRangeNear, defaultVoiceVolumetricRadius, false);
        }
        public void SetPlayerVoiceModeEarmuffs(VRCPlayerApi player)
        {
            SetPlayerVoice(player, defaultVoiceGain, 4.0f, defaultVoiceRangeNear, defaultVoiceVolumetricRadius, false);
        }
    }
}
